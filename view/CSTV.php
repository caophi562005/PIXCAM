...
<div class="content">
    <div class="content_CSTV">
        ...
        <br /><br /><br />
        <div class="cstv"><b class="hang1">Chính sách thành viên</b></div>
        <br />
        <b>1. Hạng Member:</b><br /><br />

        Khách hàng đăng ký thẻ thành viên tại các cơ sở cửa hàng của PIXCAM trên
        toàn quốc với điều kiện hóa đơn trên 500.000VNĐ<br /><br />
        ...
        Khi tích lũy đủ triệu đồng, bạn sẽ được nâng hạng thẻ PLATINUM với ưu
        đãi:<br /><br />
        ...
        Khi tích đủ 100.000.000 triệu đồng, bạn sẽ được lên hạng thẻ DIAMOND với
        ưu đãi hấp dẫn:<br /><br />
        ...
        Mỗi lần thanh toán khách hàng sẽ được cộng số điểm tương ứng với giá trị
        đơn hàng. Khi tích đủ điểm, quý khách tự động được thăng hạng trong hệ
        thống và được nhân viên thông báo để đổi thẻ mới. <br /><br />
    </div>
</div>
<?php
